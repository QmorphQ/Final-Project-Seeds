...
const Menu = () => {
  ...
  const cardsList = propArr.map((e) => (

    <Accordion key={Date.now()}>
              <AccordionSummary
              ...
              >
                <MenuItem>
                  <ListItemText>{e.parentId.toUpperCase()}</ListItemText>
                </MenuItem>
              </AccordionSummary>
              {e.name.map((item) => (
            <AccordionDetails key={Date.now()}>
            <Link href={`${e.parentId}/${item}`} underline="none">{item.toUpperCase()}</Link>
                </AccordionDetails>
          ))}
              {/* <AccordionDetails>
