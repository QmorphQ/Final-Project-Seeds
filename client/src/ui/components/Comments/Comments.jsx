...
const tutorialSteps = [

    {
        ...
        title3: 'Carla Samantoes-Diego',
        subheader3: '12.09.2021',
        text3: 'SEEDRA Spinach Seeds - contains 600 seeds in 2 Packs and professional instructions created by PhD Helga George\n' +
            'Be sure of our quality - the freshest batches of this season. Non-GMO, Heirloom - our seeds were tested and have the best germination ratings.',
        imgPath3: ' ',
    },
    {
        ...
        text3: 'SEEDRA Spinach Seeds - contains 600 seeds in 2 Packs and professional instructions created by PhD Helga George\n' +
            'Be sure of our quality - the freshest batches of this season. Non-GMO, Heirloom - our seeds were tested and have the best germination ratings.',
        imgPath3: 'https://images.unsplash.com/photo-1518732714860-b62714ce0c59?auto=format&fit=crop&w=400&h=250&q=60',
    },
    {
        title: 'Carla Samantoes-Diego',
        subheader: '12.09.2021',
        ...
        text3: 'SEEDRA Spinach Seeds - contains 600 seeds in 2 Packs and professional instructions created by PhD Helga George\n' +
            'Be sure of our quality - the freshest batches of this season. Non-GMO, Heirloom - our seeds were tested and have the best germination ratings.',
        imgPath3: 'https://scontent.fiev22-1.fna.fbcdn.net/v/t1.6435-9/84621804_889691094793888_1280812689945264128_n.jpg?_nc_cat=1&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=_AsIS0GxOGcAX8-sXgG&_nc_ht=scontent.fiev22-1.fna&oh=00_AT8dS-c_0OcsJ1MpxdiMF-dcMraDCOLqMOUWob7fnnWs7g&oe=621DAF5D',
    },
];
                                        ...
                                        <Box>
                                            <Paper square elevation={0} className={classes.header}>
                                                <CardHeader
                                                    ...
                                                    title={tutorialSteps[activeStep].title2}
                                                    subheader={tutorialSteps[activeStep].subheader2}
                                                />
                                            </Paper>
                                            <Box pl={2}>
                                                <Rating name="half-rating-read" defaultValue={4.5} precision={0.1} readOnly/>
                                            ...
                                            <CardContent>
                                                <Typography variant="body2" color="text.primary">
                                                    {tutorialSteps[activeStep].text2}
                                                </Typography>
                                            </CardContent>
                                        </Box>
                                    </Card>
                                    ...
                                    <Card sx={{maxWidth: 540, borderRadius: "12px"}} >
                                        <Paper square elevation={0} className={classes.header}>
                                            <CardHeader
                                                ...
                                                sx={{color: 'text.disabled'}}
                                                title={tutorialSteps[activeStep].title3}
                                                subheader={tutorialSteps[activeStep].subheader3}
                                            />
                                        </Paper>
                                        <Box pl={2}>
                                            <Rating name="half-rating-read" defaultValue={4.5} precision={0.1} readOnly/>
                                        ...
                                        <CardContent>
                                            <Typography variant="body2" color="text.disabled">
                                                {tutorialSteps[activeStep].text3}
                                            </Typography>
                                        </CardContent>
                                    </Card>
                                </Grid>
